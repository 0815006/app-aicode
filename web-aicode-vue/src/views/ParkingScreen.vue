      ...
      floors: [
        ...
        // - 中部双排岛：上排车头朝北，下排车头朝南，尾对尾
        {
          ...
          blocks: [
            ...
            // 按PRD：A01-A08(测试部8个) + B118-B119(综合管理部2个) + B114-B115(开发三部2个) + B110-B112(开发一部3个) + B116-B117(开发三部2个) + B081-B090(开发二部10个) + B091-B092(技术平台部2个) + B155(开发一部1个)
            // 测试部 A01-A08（8个）
            { x: 80, y: 0, dir: 'vh', count: 8, dept: '测试部', prefix: 'A', startNo: 1 },
            // 综合管理部 B118-B119（2个）
            ...
            // A11-A18（8个）
            { x: 80, y: 405, dir: 'vh', count: 8, dept: '测试部', prefix: 'A', startNo: 11 },
